...
def main(args):
    ...
    df.to_csv(f"topics_ores_scores{suffix}.csv", index=False)

    records = df.to_dict(orient="records")
    save_path = os.path.join(args.output_dir, f"topics_ores_scores{suffix}.json")
    dump_json(records, save_path, ensure_ascii=False)
