...
from config.constants import SECRETS_FILE

def main(args):
    # Load API key from the specified toml file path
    load_api_key(toml_file_path=SECRETS_FILE)
    ...
    conv_simulator_lm = ModelClass(model=gpt_4_model_name, max_tokens=500, **openai_kwargs)
